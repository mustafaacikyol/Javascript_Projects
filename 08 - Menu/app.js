...
let categories = menu.reduce(function(accumulator, current) {
...
btns.forEach(function(btn) {
    btn.addEventListener('click', function() {
        let categoryItems = menu.filter(function(item) {
            return btn.dataset.id === item.category;
...
function displayMenuItems(arr) {
    let menuItems = arr.map(function(item) {
